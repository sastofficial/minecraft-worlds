...
tag @e[type=minecraft:armor_stand,tag=casTemp,limit=1] add casDisco
tag @e[type=minecraft:armor_stand,tag=casTemp,limit=1] add casTick
scoreboard players set @e[type=minecraft:armor_stand,tag=casTemp,limit=1] cas_click 240
team join red @e[type=minecraft:armor_stand,tag=casTemp,limit=1]
