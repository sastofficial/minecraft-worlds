...
execute if score Reward Reward matches 1 run give @s minecraft:enchanted_book{StoredEnchantments:[{id:"minecraft:feather_falling",lvl:4}]} 1
execute if score Reward Reward matches 1 run tellraw @s {"color":"green","text":" +1 Feather Falling III Enchanted Book"}
execute if score Reward Reward matches 1 run give @s minecraft:elytra{Enchantments:[{id:"minecraft:unbreaking",lvl:3}]} 1
