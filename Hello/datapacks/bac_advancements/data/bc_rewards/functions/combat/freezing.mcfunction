...
execute if score Reward Reward matches 1 run give @s minecraft:enchanted_book{StoredEnchantments:[{id:"minecraft:smite",lvl:2}]} 1
execute if score Reward Reward matches 1 run tellraw @s {"color":"green","text":" +1 Smite II Enchanted Book"}
